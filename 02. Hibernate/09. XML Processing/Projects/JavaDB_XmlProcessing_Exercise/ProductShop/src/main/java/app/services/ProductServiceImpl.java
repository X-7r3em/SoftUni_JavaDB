...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public String seedProducts(List<ProductDto> productDtos) {
    ...
    @Override
    public ProductWrapperResultDto productsInRange(BigDecimal lower, BigDecimal bigger) {
        ...
        return new ProductWrapperResultDto(productResultDtos);
    }
}
