...
import app.domain.dto.query2.CarIdDto;
...
public class CarServiceImpl implements CarService {
    ...
    @Override
    @Transactional
    public String seedCars(List<CarDto> carDtos) {
    ...
    @Override
    public CarIdWrapperDto findCarsByMake(String make) {
        return new CarIdWrapperDto(
                this.carRepository
    ...
    @Override
    @Transactional
    public ListWrapperDto findCarsAndParts() {
        ...
        return new ListWrapperDto(wrapperDtos);
    }
}
