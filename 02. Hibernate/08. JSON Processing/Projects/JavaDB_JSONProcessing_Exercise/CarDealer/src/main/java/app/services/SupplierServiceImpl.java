...
public class SupplierServiceImpl implements SupplierService {
    ...
    @Override
    public String seedSuppliers(SupplierDto[] supplierDtos) {
    ...
    @Override
    public List<SupplierIdDto> findAllSuppliersByImport(boolean isImporter) {
        return this.supplierRepository.findAllByImporterIs(isImporter);
    }
}
